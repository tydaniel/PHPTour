...
<!--
    ...
    {
    <?php if ($is_image) { ?>
            if (doucment.validateform.picpath.value)
                $("#previewpic").attr("src", doucment.validateform.upload.value);
    <?php } ?>
    }
...
<div class="        jumbotron">
  <div class="            container">
    ...
    <div class="media-body">
        ...
        <form name="formupload" method="post" action="<?php echo current_url() ?>" enctype="multipart/form-data" onSubmit="retur                        n doCheck();">
                    <input name="upload" type="file" size="15" onChang                            e="previewimage()">
