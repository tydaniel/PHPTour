    ...
    <?php if($data_list):?>
        <table class="table table-hover dataTable" id="checkAll">
          <thead>
            <tr>
              <th>#</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_name&dir=desc'); ?>
              <?php if(($order=='book_name'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_name&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">图书名</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_author&dir=desc'); ?>
              <?php if(($order=='book_author'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_author&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">作者</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_publishing&dir=desc'); ?>
              <?php if(($order=='book_publishing'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_publishing&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">出版社</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_class&dir=desc'); ?>
              <?php if(($order=='book_class'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_class&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">图书种类</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_no&dir=desc'); ?>
              <?php if(($order=='book_no'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_no&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">ISBN</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=create_user&dir=desc'); ?>
              <?php if(($order=='create_user'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=create_user&dir=asc'); ?>
              ...
              <?php } ?><th class="sorting <?php echo $css;?>"   onclick="window.location.href='<?php echo $next_url;?>'"   nowrap="nowrap">创建人</th>
                            <?php $css=""; $next_url = base_url('adminpanel/bookadmin?order=book_total&dir=desc'); ?>
              <?php if(($order=='book_total'&&$dir=='desc')) { ?>
              <?php $css="sorting_desc";$next_url = base_url('adminpanel/bookadmin?order=book_total&dir=asc'); ?>
