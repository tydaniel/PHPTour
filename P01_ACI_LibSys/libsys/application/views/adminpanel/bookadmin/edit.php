        ...
        <div class='panel-body '>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 ">
                        <textarea name="abstract"  id="abstract"  cols="45" rows="5" class="form-control " placeholder="请输入概要信息" > <?php echo isset($data_info['abstract']) ? $data_info['abstract'] : '' ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 ">
                        <a id="picture_show_a"  ><img  width="100" id="picture_show_SRC" border="1" src="<?php echo SITE_URL ?><?php echo isset($data_info["picture_show"]) ? BOOK_PIC . $data_info["picture_show"] : "images/nopic.gif" ?>"/></a>
                        <input type="hidden" id="picture_show" name="picture_show" value="<?php echo isset($data_info["picture_show"]) ? $data_info["picture_show"] : "" ?>" /> <a id="picture_show_b" class="btn btn-default btn-sm" > 选择图片 ...</a><span class="help-block">只支持图片上传.</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 ">
                        <textarea name="description"  id="description"  cols="45" rows="5" class="form-control " placeholder="请输入介绍" ><?php echo isset($data_info['description']) ? $data_info['description'] : '' ?></textarea>
                    </div>
                </div>
            </fieldset>
